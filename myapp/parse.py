...
class BaseParser:
    ...
    def get_price_image(self, product):
        ...
        self.result["price"] = product.select_one(".Nx9bqj").text if product.select_one(".Nx9bqj") else ''
        if product.select_one(".DShtpz"):
            self.result['details']['stock']=product.select_one(".DShtpz").text
            self.result['stock'] = False
